...
describe('Testing input parameter Phone', () => {
	...
	describe('Test 2', () => {
		...
		const result = ['+18175698900', 'USA', 'US'];
		test('returns ' + result, () => {
			expect(phone(number)).toEqual(result);
		});
	});
	...
	describe('Test 3', () => {
		...
		const result = ['+85265698900', 'HKG', 'HK'];
		test('returns ' + result, () => {
			expect(phone(number)).toEqual(result);
		});
	});
	...
	describe('Test 6', () => {
		test('should remove the leadings zero when country is CIV', () => {
			expect(phone('+225 05345678', 'CIV')).toEqual(['+22505345678', 'CIV', 'CI']);
		});

		test('should remove the leadings zero when country is COG', () => {
			expect(phone('+242 012345678', 'COG')).toEqual(['+242012345678', 'COG', 'CG']);
		});
	});
});
...
describe('Testing USA Phone', () => {
	...
	describe('Test 4', () => {
		...
		const country = '';
		const result = ['+12121234567', 'USA', 'US'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('Test 5, does not provide country, should match canada phone number', () => {
		...
		const country = '';
		const result = ['+12265698900', 'CAN', 'CA'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('Test 6', () => {
		...
		const country = '';
		const result = ['+12255698900', 'USA', 'US'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('Test 14', () => {
		...
		const result = ['+18885698900', 'USA', 'US'];
		test('returns ' + result, () => {
			expect(phone(number)).toEqual(result);
		});
	});
...
describe('Testing default Canada phone number', () => {
	describe('Test 1, does not provide country, should match canada phone number', () => {
		...
		const country = '';
		const result = ['+19055551234', 'CAN', 'CA'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('Test 2, does not provide country and plus sign, should match canada phone number', () => {
		...
		const country = '';
		const result = ['+15195551234', 'CAN', 'CA'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
...
describe('Testing +1 but NOT in USA', () => {
	describe('+1 340  United States Virgin Islands', () => {
		...
		const country = 'VIR';
		const result = ['+13401234567', 'VIR', 'VI'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('+1 670 Northern Mariana Islands', () => {
		...
		const country = 'MNP';
		const result = ['+16701234567', 'MNP', 'MP'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('+1 671 Guam', () => {
		...
		const country = 'GUM';
		const result = ['+16711234567', 'GUM', 'GU'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('+1 684 American Samoa', () => {
		...
		const country = 'ASM';
		const result = ['+16842584567', 'ASM', 'AS'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('+1 684 American Samoa', () => {
		...
		const country = 'ASM';
		const result = ['+16847334567', 'ASM', 'AS'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('+1 787 / 939 Puerto Rico', () => {
		...
		const country = 'PRI';
		const result = ['+17871234567', 'PRI', 'PR'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('+1 787 / 939 Puerto Rico', () => {
		...
		const country = 'PRI';
		const result = ['+19391234567', 'PRI', 'PR'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('+1 242 Bahamas', () => {
		...
		const country = 'BHS';
		const result = ['+12421234567', 'BHS', 'BS'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	describe('+1 246 Barbados', () => {
		...
		const country = 'BRB';
		const result = ['+12461234567', 'BRB', 'BB'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('+1 264 Anguilla', () => {
		...
		const country = 'AIA';
		const result = ['+12645234567', 'AIA', 'AI'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('+1 264 Anguilla', () => {
		...
		const country = 'AIA';
		const result = ['+12647234567', 'AIA', 'AI'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('+1 268 Antigua and Barbuda', () => {
		...
		const country = 'ATG';
		const result = ['+12687234567', 'ATG', 'AG'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('+1 284 British Virgin Islands', () => {
		...
		const country = 'VGB';
		const result = ['+12841234567', 'VGB', 'VG'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('+1 345 Cayman Islands', () => {
		...
		const country = 'CYM';
		const result = ['+13451234567', 'CYM', 'KY'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('+1 441 Bermuda', () => {
		...
		const country = 'BMU';
		const result = ['+14413234567', 'BMU', 'BM'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('+1 441 Bermuda', () => {
		...
		const country = 'BMU';
		const result = ['+14415234567', 'BMU', 'BM'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('+1 441 Bermuda', () => {
		...
		const country = 'BMU';
		const result = ['+14417234567', 'BMU', 'BM'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('+1 473 Grenada', () => {
		...
		const country = 'GRD';
		const result = ['+14731234567', 'GRD', 'GD'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('+1 649 Turks and Caicos Islands', () => {
		...
		const country = 'TCA';
		const result = ['+16492234567', 'TCA', 'TC'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('+1 664 Montserrat', () => {
		...
		const country = 'MSR';
		const result = ['+16641234567', 'MSR', 'MS'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('+1 721 Sint Maarten', () => {
		...
		const country = 'SXM';
		const result = ['+17211234567', 'SXM', 'SX'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('+1 758 Saint Lucia', () => {
		...
		const country = 'LCA';
		const result = ['+17581234567', 'LCA', 'LC'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('+1 767 Dominica', () => {
		...
		const country = 'DMA';
		const result = ['+17671234567', 'DMA', 'DM'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('+1 784 Saint Vincent and the Grenadines', () => {
		...
		const country = 'VCT';
		const result = ['+17841234567', 'VCT', 'VC'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('+1 809 / 829 / 849 Dominican Republic', () => {
		...
		const country = 'DOM';
		const result = ['+18091234567', 'DOM', 'DO'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('+1 809 / 829 / 849 Dominican Republic', () => {
		...
		const country = 'DOM';
		const result = ['+18291234567', 'DOM', 'DO'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('+1 809 / 829 / 849 Dominican Republic', () => {
		...
		const country = 'DOM';
		const result = ['+18491234567', 'DOM', 'DO'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('+1 868 Trinidad and Tobago', () => {
		...
		const country = 'TTO';
		const result = ['+18681234567', 'TTO', 'TT'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('+1 869 Saint Kitts and Nevis', () => {
		...
		const country = 'KNA';
		const result = ['+18691234567', 'KNA', 'KN'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('+1 876 Jamaica', () => {
		...
		const country = 'JAM';
		const result = ['+18761234567', 'JAM', 'JM'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
...
describe('Testing MEX Phone', () => {
	...
	describe('Test 1', () => {
		...
		const country = null;
		const result = ['+5217621009517', 'MEX', 'MX'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('Test 12', () => {
		...
		const country = 'MEX';
		const result = ['+527621009517', 'MEX', 'MX'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
...
describe('Testing HKG Phone Quick Test', () => {
	describe('Test 1', () => {
		...
		const country = 'HKG';
		const result = ['+85261236123', 'HKG', 'HK'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
...
describe('Testing BRA Phone Quick Test', () => {
	describe('Test 1', () => {
		...
		const country = 'BRA';
		const result = ['+5511961231234', 'BRA', 'BR'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('Test 4', () => {
		...
		const country = 'BRA';
		const result = ['+5569861231234', 'BRA', 'BR'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('Test 5', () => {
		...
		const country = 'BRA';
		const result = ['+5565991234567', 'BRA', 'BR'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('Test 6', () => {
		...
		const country = 'BRA';
		const result = ['+5599988311895', 'BRA', 'BR'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
...
describe('Testing PRI Phone Quick Test', () => {
	describe('Test 1', () => {
		...
		const country = 'PRI';
		const result = ['+17876729999', 'PRI', 'PR'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
...
describe('Testing RUS Phone Quick Test', () => {
	describe('Test 1', () => {
		...
		const country = 'RUS';
		const result = ['+79234567890', 'RUS', 'RU'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
...
describe('Testing THA Phone Quick Test', () => {
	describe('Test 1', () => {
		...
		const country = 'THA';
		const result = ['+66812345678', 'THA', 'TH'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('Test 2', () => {
		...
		const country = 'THA';
		const result = ['+66912345678', 'THA', 'TH'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
...
describe('Testing TZA Phone Quick Test', () => {
	describe('Test 1', () => {
		...
		const country = 'TZA';
		const result = ['+255714795861', 'TZA', 'TZ'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('Test 2', () => {
		...
		const country = 'TZA';
		const result = ['+255684795861', 'TZA', 'TZ'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
...
describe('Testing KAZ Phone Quick Test', () => {
	describe('Test 1', () => {
		...
		const country = 'KAZ';
		const result = ['+77012345678', 'KAZ', 'KZ'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('Test 2', () => {
		...
		const country = 'KAZ';
		const result = ['+77412345678', 'KAZ', 'KZ'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
	...
	describe('Test 3', () => {
		...
		const country = 'KAZ';
		const result = ['+77712345678', 'KAZ', 'KZ'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
...
describe('Testing PAN Phone Quick Test', () => {
	describe('Test 1', () => {
		...
		const country = 'PAN';
		const result = ['+50761234567', 'PAN', 'PA'];
		test('returns ' + result, () => {
			expect(phone(number, country)).toEqual(result);
		});
	});
...
describe('Testing MUS Phone Quick Test', () => {
	describe('Test 1', () => {
		...
		const result = ['+23051234567', 'MUS', 'MU'];
		test('returns ' + result, () => {
			expect(phone(number)).toEqual(result);
		});
	});
...
describe('Testing CHN Phone Quick Test', () => {
	...
	describe('Test for pattern 199', () => {
		...
		const result = ['+8619951343779', 'CHN', 'CN'];
		test('returns ' + result, () => {
			expect(phone(number)).toEqual(result);
		});
	});
	...
	describe('Test for pattern 198', () => {
		...
		const result = ['+8619851343779', 'CHN', 'CN'];
		test('returns ' + result, () => {
			expect(phone(number)).toEqual(result);
		});
	});
	...
	describe('Test for pattern 166', () => {
		...
		const result = ['+8616651343779', 'CHN', 'CN'];
		test('returns ' + result, () => {
			expect(phone(number)).toEqual(result);
		});
	});
...
describe('Testing ARG numbers', () => {
	describe('Test for number without 9 prefix', () => {
		...
		const result = ['+542331234567', 'ARG', 'AR'];
		test('returns ' + result, () => {
			expect(phone(number)).toEqual(result);
		});
	});
...
describe( 'Testing MMR Phone', () => {
	describe('Test for 8 digits mobile numbers ', () => {
		...
		const result = ['+9595500000', 'MMR', 'MM'];
		test('returns ' + result, () => {
			expect(phone(number)).toEqual(result);
		});
	});
	describe('Test for 9 digits mobile numbers ', () => {
		...
		const result = ['+95930000000', 'MMR', 'MM'];
		test('returns ' + result, () => {
			expect(phone(number)).toEqual(result);
		});
	});
	describe('Test 10 digits mobile numbers', () => {
		...
		const result = ['+959426000000', 'MMR', 'MM'];
		test('returns ' + result, () => {
			expect(phone(number)).toEqual(result);
		});
	});
...
describe( 'Testing Canada Phone', () => {
	describe('Should return result when it matches mobile_begin_with', () => {
		...
		const result = ['+13671234567', 'CAN', 'CA'];
		test('returns ' + result, () => {
			expect(phone(number)).toEqual(result);
		});
	});
...
describe( 'Testing Cameroon Phone', () => {
	describe('Should return result when it matches mobile_begin_with', () => {
		...
		const result = ['+237612345678', 'CMR', 'CM'];
		test('returns ' + result, () => {
			expect(phone(number)).toEqual(result);
		});
	});
...
describe( 'Testing Ukraine Phone', () => {
	describe('Should return result when it matches mobile_begin_with', () => {
		...
		const result = ['+380731234567', 'UKR', 'UA'];
		test('returns ' + result, () => {
			expect(phone(number)).toEqual(result);
		});
	});
...
describe('test phone with trunk prefix', () => {
	test('Austrilia phone with trunk prefix (0)', () => {
		...
		const result = ['+61488888888', 'AUS', 'AU'];
		expect(phone(number)).toEqual(result);
	});
	...
	test('Micronesia with trunk prefix (0)', () => {
		...
		const result = ['+6911234567', 'FSM', 'FM'];
		expect(phone(number)).toEqual(result);
	});
});
...
describe('Landline phone number test', () => {
	test('Test mobile phone number, should success', () => {
		...
		const result = ['+85293785433', 'HKG', 'HK'];
		expect(phone(number)).toEqual(result);
	});
	...
	test('Test landline phone number with 3rd parameter, should success', () => {
		const number = '+85223785433';
		const result = ['+85223785433', 'HKG', 'HK'];
...
describe('#190 phone number with plus sign BUT without country code (intentionally wrong input)', () => {
	...
	test('4b. without +, without country code, with country, should get the result', () => {
		...
		const country = 'USA';
		const result = ['+12014125632', 'USA', 'US'];
		expect(phone(number, country)).toEqual(result);
	});
	...
	test('4c. without +, without country code, with country, should get the result', () => {
		const number = '41414141';
		const country = 'NO';
		const result = ['+4741414141', 'NOR', 'NO'];
		expect(phone(number, country)).toEqual(result);
	});
