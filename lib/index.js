...
module.exports = function (phone, country) {
	...
	if (formatCountry) {
		...
		let possible_iso3166;
		[iso3166, possible_iso3166] = getIso3166ByPhone(formatPhone);

		if (!iso3166) {
			// for some couries, the phone number usually includes one trunk prefix for local use
	...
	if (validatePhoneIso3166(formatPhone, iso3166)) {
