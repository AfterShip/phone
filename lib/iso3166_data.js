...
module.exports = [
  ...
  // {alpha2: 'GS', alpha3: 'SGS', country_code: '500', country_name: 'South Georgia and the South Sandwich Islands', mobile_begin_with: [], phone_number_lengths: []},
	...
	},
	{
		...
		country_name: 'Sweden',
		mobile_begin_with: ['7'],
		phone_number_lengths: [9, 10, 11, 12, 13] // 9 is the default length, but up to 13 is supported by the networks and is used in reality and then called "virtual numbers"
	},
